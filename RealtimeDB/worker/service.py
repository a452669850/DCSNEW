...
from RealtimeDB.exception import SkError
from RealtimeDB.define import CmdType, KCommand, KReply
from RealtimeDB.model import DevModel
from RealtimeDB.worker.state import SkWorkerState, register_dev
        ...
        while True:
            ...
            try:
                if cmd.type == CmdType.SETUP:
                    ...
                    state.slots = list(map(register_dev, DevModel.select()))
